    ...
    get filteredNotifications() {
      ...
      return notifications.filter((notification) => {
        ...
        if (
          ...
          notification.isArchived !== filters.isArchived
        ) {
          return false;
        }
...
export const useFilteredNotifications = () =>
  useNotificationsStore((state) => state.filteredNotifications);
export const useNotificationStats = () =>
  useNotificationsStore((state) => state.stats);
export const useRecentNotifications = () =>
  useNotificationsStore((state) => state.recentNotifications);
export const useUrgentNotifications = () =>
  useNotificationsStore((state) => state.urgentNotifications);
